        ...
        <div class="info">
            <div class="info-row">
                ...
                <div class="info-cell">
                    ...
                    <p><strong>Bác sĩ:</strong> {{ $doctor_name ?? 'N/A' }}</p>
                </div>
            </div>
        </div>
        ...
        <table class="no-break">
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="text-right">{{ number_format($tong, 0, ',', '.') }}</td>
                </tr>
            </tfoot>
        </table>
        @else
        <div class="diagnosis-item">
            <strong>ĐƠN THUỐC:</strong> Không có đơn thuốc
        </div>
        @endif

        @if($hasPrescriptions && $tong > 0)
