...
import { path } from "../utils/constant"; // Giả sử đường dẫn này đúng
...
const Home = () => {
    ...
    const doctors = [
        ...
        { name: "BS. Trần Thị B", specialty: "Chuyên khoa Nội tổng quát", image: "https://placehold.co/150x150/e9ecef/333333?text=BS.+B" },
        { name: "BS. Lê Văn C", specialty: "Chuyên khoa Răng - Hàm - Mặt", image: "https://placehold.co/150x150/e9ecef/333333?text=BS.+C" },
        { name: "BS. Phạm Anh D", specialty: "Chuyên khoa Tim Mạch", image: "https://placehold.co/150x150/e9ecef/333333?text=BS.+D" },
    ];

    return (
        <>
            {/* Header: Nâng cấp lên Navbar của react-bootstrap */}
            <Navbar bg="white" shadow-sm="true" sticky="top" expand="lg" className="shadow-sm">
                <Container>
                    ...
                    <Navbar.Brand as={Link} to="/" className="d-flex align-items-center gap-2">
                        ...
                        />
                        <span className="fs-4 fw-bold text-primary">Phòng Khám VitaCare</span>
                    </Navbar.Brand>
            ...
            <section
                ...
                style={{
                    // Cập nhật ảnh placeholder
                    background: "linear-gradient(rgba(0,91,179,.7), rgba(0,91,179,.7)), url('bg.png') center/cover no-repeat",
                    minHeight: "60vh",
                    display: "flex",
                    alignItems: "center",
                }}
                        ...
                        {services.map((sv, index) => (
                            <div className="col-md-4" key={index}>
                                ...
                                <div className="card shadow-sm h-100 p-4 border-0 rounded-3">
                                    {/* Cập nhật class icon */}
                                    <i className={`bi ${sv.icon} display-3 text-primary mb-3`}></i>
                                    <h3>{sv.title}</h3>
            ...
            <footer className="bg-dark text-white py-5 text-center">
                <Container>
                    ...
                    <div className="d-flex justify-content-center fs-3 gap-4 mb-4">
                        ...
                        <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="text-white text-decoration-none">
                    ...
                    <p className="mb-1">Địa chỉ: 123 Đường Sức Khỏe, Phường An Lành, Quận Bình Yên, TP. Hồ Chí Minh</p>
